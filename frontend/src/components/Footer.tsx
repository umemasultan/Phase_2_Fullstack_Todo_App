    ...
    <footer className="bg-white border-t border-gray-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-gray-600">Built by Umema Sultan</p>

          <div className="flex flex-wrap justify-center gap-3 pt-2">
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/umema-sultan"
              target="_blank"
            ...
            {/* TikTok */}
            <a
              href="https://www.tiktok.com/@codedremer"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <span>@codedremer</span>
            </a>

            {/* WhatsApp */}
            <a
              href="https://whatsapp.com/channel/0029VajhSWv77qVa4QVQJX3u"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="pt-4 border-t border-gray-200 mt-6">
            <p className="text-xs text-gray-500">
              © {new Date().getFullYear()} Hackathon Todo. Built with Next.js, FastAPI, and SQLite.
            </p>
          </div>
        </div>
      </div>
